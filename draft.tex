...
\begin{abstract}
    ...
    This thesis demonstrates the existence of context effects in multi-attribute, multidimensional settings and develops methodologies on enhancing recommender systems design with context effects. Also, this study investigates context arising outside the choice set, namely, the tools that allows users to express their preferences.
...
The context in which a consumer makes decisions significantly influences their choices. This thesis investigates the role of context effects in consumer decision-making and applies this knowledge to enhance recommender systems in online marketplaces. Leveraging a computational model known as MDbS, we examine the impact of context effects in real-world choice data. Our findings indicate that these effects, previously studied primarily in experimental settings, also manifest in field scenarios. This insight enables online platforms to utilize mathematical decision-making models to better tailor their product lists and recommendations.

Our work extends beyond current measures of context effects by making contextual choice modeling applicable to a wider range of observational data. This approach paves the way to study context effects in various settings and opens up opportunities for optimizing recommender systems in e-commerce platforms. We also propose a novel approach to tackle the user-side continuous cold-start problem in recommender system design, using the context information of the product menu to generate relevant choice sets.

Further, we delve into the role of user control on recommender systems' acceptance, using the Technology Acceptance Model (TAM) as a theoretical framework. Our findings suggest that users perceive easy-to-use recommender systems as more useful and intend to use them more. We also find that different control mechanisms can have varying impacts on user experience, leading to diverse effects on user acceptance of recommender systems.

This thesis offers valuable insights for online marketplaces and recommender systems, showcasing the benefits of considering context effects in product presentation and user decision-making processes. Our research also identifies future directions for enhancing user control in recommender systems, including the integration of large language models for more intuitive and transparent user interactions. By recognizing the dynamic nature of user preferences and the significant role of context effects in decision-making, our work contributes to the design of more effective and user-centric recommender systems.
...
It was previously observed that users' preferences are prone to change over time. They become bored with the similarity of the items they have consumed and suggested and want more personalization \citep{songWhenHowDiversify2019}. This makes RS adaptation to dynamic user preference extremely important. To mitigate RS low ability to "evolve" alongisde with the users' preferences, system engineers have introduced user control mechanisms to allow users to participate in personalization. 
