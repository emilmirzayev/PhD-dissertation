...
\begin{abstract}
    ...
    The third study presented a novel approach to addressing the user-side cold-start problem in recommender system design. It applied the findings of two-stage choice process observed in individuals to contextual information extracted from the choice set via clustering to generate consideration sets. The approach proved to be robust to clustering method and different heuristics applied. Its findings pave the way for investigating context effects arising from outside the choice sets, namely the preferences of individuals and the user control tools that allows individuals to signal their preferences in designing. This is argued to be one of the main mechanisms to create more effective recommender systems.
