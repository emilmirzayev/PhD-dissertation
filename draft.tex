...
\begin{abstract}
    ...
    This thesis demonstrates the existence of context effects in multi-attribute, multidimensional settings and develops methodologies on enhancing recommender systems design with context effects. Additionally, this study investigates external context, namely, the tools that allows users to express their preferences and how to make recommender systems better through them.
